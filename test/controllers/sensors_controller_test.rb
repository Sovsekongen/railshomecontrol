...
class SensorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sensor" do
    assert_difference('Sensor.count') do
      post sensors_url, params: { sensor: { lastu: @sensor.lastu, location: @sensor.location, name: @sensor.name, time: @sensor.time, type: @sensor.type, unit: @sensor.unit, value: @sensor.value } }
    end
  ...
  test "should update sensor" do
    patch sensor_url(@sensor), params: { sensor: { lastu: @sensor.lastu, location: @sensor.location, name: @sensor.name, time: @sensor.time, type: @sensor.type, unit: @sensor.unit, value: @sensor.value } }
